...
static const int64 MAX_MONEY = 10200000 * COIN;  // ecocoin: maximum of 10,200,000 coins
...
static const uint256 hashGenesisBlockOfficial("0x00000e5e0d20097657ec2cfa0d050dd7626e5a700d14f0ec6fb57b7168c2d707");
static const uint256 hashGenesisBlockTestNet("0x00000063599627e87d83156ef4d3075e1a711354e0c2b0bf832d34b900fafcde");
...
// ecocoin: calculate Nfactor using timestamp
...
public:
    ...
    {
        // ecocoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // ecocoin: get transaction coin age
...
public:
    ...
    // ecocoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // ecocoin: entropy bit for stake modifier if chosen by modifier
...
// DIFF: protocol switch not needed as soon as newer version can be used
    ...
    // ecocoin: two types of block: proof-of-work or proof-of-stake
    ...
    // ecocoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // ecocoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // ecocoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // ecocoin: block index flags
    enum  
    {
