...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ecocoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"ecocoin.info", "seed.ecocoin.info"},    // WM - Umm...  FIXME
	{"ecocoin.info", "84.200.17.153"},
	{"ecocoin.info", "84.200.68.162"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("ecocoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EcoCoin is probably already running."), addrBind.ToString().c_str());
        else
...
*/
    ...
    // ecocoin: mint proof-of-stake blocks in the background
